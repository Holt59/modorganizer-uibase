 ...
 * destination directory to copy to. There has to be one destination name for each
 * source name or a single directory
 ...
 * @param destinationNames names of the files in the destination location or the
 * destination directory to move to. There has to be one destination name for each
 * source name or a single directory
 * @param dialog a dialog to be the parent of possible confirmation dialogs
 * @return true on success, false on error. Call ::GetLastError() to retrieve error code
 */
 ...
 *
 * @return the file version, or an empty string if the file version could not be
 * retrieved.
 */
 ...
 * @param filepath Absolute path to the executable.
 *
 * @return the file version, or an empty string if the product version could not be
 * retrieved.
 */
